...
$page->title = "Wolfography | Impressum"; 
$page->pageTitle = "Impressum";
  ...
  <div class="col-xs-12 col-lg-4">
    <div class="card">
      <div class="card-block">
        ...
        <p class="card-text">
          UID-Nr: Coming 2016<br/>
          Kammer: Wirtschaftskammer Wien<br/>
          Fachgruppen: Fotografen &amp; EDV Dienstleister
        </p>
        <p class="card-text">
          IBAN: <?php include("widgets/iban.php") ?><br/>
          BIC: WIREDEMMXXX
        </p> 
      </div>
    </div>
